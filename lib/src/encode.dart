...
class TerminalEncode extends TerminalConfig {
  List<String> completionKey(
    ...
    final lengthMsgs = [
      ...
      ...PresentationHeader(transactionName: transactionName).presentationHeader,
      ...msgs
    ];
    List<String> length = [];
  ...
  List<String> purchase(String transactionId, int amount, int cashbackAmount,
      {PaymentBy by = PaymentBy.all, bool receipt = true}) {
    final flag = receipt == true ? "1" : "0";
    ...
    final List<String> fieldDatas = [
      ...
      // ...FieldCodeList(fieldName: FieldName.walletId).fieldData(padLeftZero(1.toString(), 2)),
      ...FieldData(name: FieldName.eppTenure)
          .fieldData(padLeftZero(12.toString(), 2)),
      // ...FieldCodeList(fieldName: FieldName.compareCardFlag).fieldData(padLeftZero(0.toString(), 2)),
